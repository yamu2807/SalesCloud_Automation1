...
public class functionLibrary extends genericFunctions {
	...
	// MyTestProjecteXAMPLE Company Codes
	String MyTestProjecteXAMPLECompanyCodes = "//a[normalize-space()='MyTestProjecteXAMPLE Company Codes']";
	String newButton = "//input[@title='New']";
	String input_MyTestProjecteXAMPLECompanyName = "//input[@name='Name']";
	String MyTestProjecteXAMPLECompanyCodeStreetTextBox = "//label[text()='Address Line 1']/ancestor::td[1]/following-sibling::td[1]/input";
	String MyTestProjecteXAMPLECompanyCodeCityTextBox = "//label[text()='City']/ancestor::td[1]/following-sibling::td[1]/input";
	String MyTestProjecteXAMPLECompanyCodeStateTextBox = "//label[text()='State']/ancestor::td[1]/following-sibling::td[1]/input";
	String MyTestProjecteXAMPLECompanyCodeCountryTextBox = "//label[text()='Country']/ancestor::td[1]/following-sibling::td[1]/input";
	String MyTestProjecteXAMPLECompanyCodeZipTextBox = "//label[text()='Postal Code']/ancestor::td[1]/following-sibling::td[1]/input";
	String clickOnSaveButton = "//td[@class='pbButton']//input[@title='Save']";
	String clickOnValidateCompanyAddress = "//td[@id='topButtonRow']//input[@title='Validate Company Address']";
	
	
	//Line Level Ship To Address: Tax Calculation
	String navigateToOpportunityProduct = "//tbody/tr/td[contains(@class,'oRight')]/div[@class='listHoverLinks']/a[1]/span[1]";
	String opprtunity_product = "//a[normalize-space()='GenWatt Diesel 1000kW']";
	String editOpportunityProduct = "//td[@id='topButtonRow']//input[@title='Edit']";
	String Opp_ProductStreetTextBox = "//tbody[1]/tr[7]/td[2]/input[1]";
	String Opp_ProductCityTextBox = "//tbody[1]/tr[8]/td[2]/input[1]";
	String Opp_ProductStateTextBox = "//tbody[1]/tr[9]/td[2]/input[1]";
	String Opp_ProductZipTextBox = "//tbody[1]/tr[10]/td[2]/input[1]";
	String Opp_ProductCountryTextBox = "//tbody[1]/tr[11]/td[2]/input[1]";
	String SaveOpp_productDetails = "//td[@id='topButtonRow']//input[@title='Save']";
	
	// Shipping and Handling Tax
	String shippingAndHanlingTax = "//tbody/tr[9]/td[4]/div[1]";
	String shippingAndHandling_amount = "100";
	...
	public void fMenuSelection(String sMenu) throws Exception {
		...
		try {
			ExecutionDelay(3);
			// Open TaxNowSettingsStartTestCase
			if (sMenu.equalsIgnoreCase("TaxNowSettings")) {
				...
				String countryTextbox = "//label[text()='Country']/ancestor::div[1]//div[1]/input";
				 ...
				 if (sGLAddressValidationFlag != null && sGLImportDutyFlag=="0" ) {
			...
			if (sMenu.equalsIgnoreCase("Orders")) {
				if (IsElementPresent(By.linkText("Orders"))) {
					...
					enterValue_LocatorID("Contract", "00000101");
			...
			if (sMenu.equalsIgnoreCase("ACcs")) {
				...
				if (sGLEnableIOR.equalsIgnoreCase("1")) {
					WebElement IOR = driver.findElement(By.xpath("//label[text()='Is Seller Importer Of Record']/ancestor::td[1]/following-sibling::td[1]/input"));
					boolean ior = false;
					ior = IOR.isSelected();
					System.out.println("IOR IS: "+IOR.isSelected());
					if(!ior)
						clickonElement_Xpath("//label[text()='Is Seller Importer Of Record']/ancestor::td[1]/following-sibling::td[1]/input");
			...
			System.out.println("fMenuSelection: Exception: " + sGLTestCaseName + oException);

		}
		
		
		// Change ACc cred for Exemption Utility feature
		if (sMenu.equalsIgnoreCase("ExemptionUtility")) {
			if (IsElementPresent(By.xpath("//a[normalize-space()='ACc cred']"))) {
				clickonElement_Xpath("//a[normalize-space()='ACc cred']");
				clickonElement_Xpath("//div[@class='slds-form-element__control slds-grow']//input[@type='text']");
				enterValue_LocatorXpath("//div[@class='slds-form-element__control slds-grow']//input[@type='text']", "2000349696");
				
				clickonElement_Xpath("//input[@type='pd']");
				enterValue_LocatorXpath("//input[@type='pd']", "34DCE531B9D5B77E");
				
			//	clickonElement_Xpath("//button[normalize-space()='Test Connection']");
				ExecutionDelay(5);
				
				selectByValue("//select[@name='aidCompanyCode']", "AB_SF");
				selectByVisibleText("//select[@name='aidEnvironment']", "Sandbox");
				clickonElement_Xpath("//button[normalize-space()='Test Connection']");
	...
	public void fMyTestProjecteXAMPLEConfigurationSettings() {
		...
		// My Test Exemptions Locators
		String enableMyTestProjecteXAMPLEExemptionsToggle = "//span[text()='Enable MyTestProjecteXAMPLE Exemptions']/ancestor::div[1]/following-sibling::div[1]//span[@class='slds-checkbox_faux']";
		String disabledMyTestProjecteXAMPLEExemptionsToggle = "//span[text()='Enable MyTestProjecteXAMPLE Exemptions']/ancestor::div[1]/following-sibling::div[1]//span[text()='Disabled']";
		String enabledMyTestProjecteXAMPLEExemptionsToggle = "//span[text()='Enable MyTestProjecteXAMPLE Exemptions']/ancestor::div[1]/following-sibling::div[1]//span[text()='Enabled']";
		...
		if (sGLEnableMyTestProjecteXAMPLEExemptions.equalsIgnoreCase("1")
				&& getTextValue(disabledMyTestProjecteXAMPLEExemptionsToggle).equalsIgnoreCase("Disabled")) {
			clickonElement_Xpath(enableMyTestProjecteXAMPLEExemptionsToggle);
		} else if (sGLEnableMyTestProjecteXAMPLEExemptions.equalsIgnoreCase("0")
				&& getTextValue(enabledMyTestProjecteXAMPLEExemptionsToggle).equalsIgnoreCase("Enabled")) {
			clickonElement_Xpath(enableMyTestProjecteXAMPLEExemptionsToggle);
		}
...
//			driver.findElement(By.name("save")).click();
	...
	public String fVerifyTaxValues(String sMenuOption) throws InterruptedException {
		...
		if (sSalesTax.length() < 2) {
			...
			sGLTotalTax = sExpectedSalesTax.trim();
	...
	/*******************************************************************************************************************
	 * Description : Function to get cross border summary message for transaction of custom duty
	 *
	 * @param sMenuOption
	 *            = On which window we are verifying tax
	 ******************************************************************************************************************/

	public String fVerifyCrossBorderSummaryMessage(String sMenuOption) throws InterruptedException{
		String message="";

		String sCrossBorderSummaryMessage ="//tr[11]/td[4]/div";

		if (sMenuOption.equalsIgnoreCase("Orders")) {
			Thread.sleep(1000);
			message = getText("//tr[11]/td[4]/div");
			Thread.sleep(1000);
		}
		System.out.println("Length of Sales tax" + message.length());

		return message;
	}
	/*******************************************************************************************************************
	 * Description : Function to get Import fees for transaction
	 *
	 * @param sMenuOption
	 *            = On which window we are verifying tax
	 ******************************************************************************************************************/

	public String fVerifyImportFeesValues(String sMenuOption) throws InterruptedException {

		String sImportFees = "//tr[9]/td[4]/div";

		String[] sImpFees;

		if (sMenuOption.equalsIgnoreCase("Opportunities")) {
			Thread.sleep(4000);
			expectvisibilityOfElementLocated(sImportFees);
			sImportFees = getText(sImportFees);
			Thread.sleep(1000);
		} else if (sMenuOption.equalsIgnoreCase("Quotes")) // For Quotes
		{
			Thread.sleep(1000);
			sImportFees = getText("//tr[12]/td[4]/div[1]");
			Thread.sleep(1000);
			double d = Double.parseDouble(sGLImportFees);
			d = d * 2;
			d = Double.parseDouble(new DecimalFormat("##.##").format(d));
			sGLImportFees = String.valueOf(d);
			sGLImportFees = sGLImportFees + "0";

		}
		if (sMenuOption.equalsIgnoreCase("Orders")) {
			Thread.sleep(1000);
			sImportFees = getText("//tr[10]/td[4]/div");
			Thread.sleep(1000);
		}
		System.out.println("Length of Sales tax" + sImportFees.length());
		if (sImportFees.length() < 2) {
			return sImportFees;
		} else {
			sImpFees = sImportFees.split("\\$");
			sExpectedImportFees = sImpFees[1].replaceAll(",", "");
			sGLImportFees = sExpectedImportFees.trim();
			System.out.println("sGLImportFees : " + sGLImportFees);
			sImportFees = sImpFees.toString();
			return sImportFees;
		}
	...
	public List<String> fSalesTaxDetailsfieldValidation() throws InterruptedException {
		...
		List<String> salesTaxDetailsfieldValues = new ArrayList<String>();
	...
	public void fUpdateOrRemoveACcNameOnTransaction(String action) throws InterruptedException {
		...
		if (action.equalsIgnoreCase("UpdateAccWithDiffEntityUseCode")) {
			...
			// Update Entity use code on Opportunity/Quotes transaction
			enterValue_LocatorXpath(ACclookUpField, "ACWithNoEntityUseCode");
		} else if (action.equalsIgnoreCase("UpdateAccWithDiffEntityUseCode_Order")) {
			// Update Entity use code on Order transaction
			enterValue_LocatorXpath(ACclookUpField, "ACWithDiffEntityUseCode");
			enterValue_LocatorID("Contract", "00000102");
		} else if (action.equalsIgnoreCase("UpdateAccWithNoEntityUseCode_Order")) {
			enterValue_LocatorXpath(ACclookUpField, "ACWithNoEntityUseCode");
		    enterValue_LocatorID("Contract", "00000103");
		}
...
//	--------------------------------------------------------------------------------------------
	public void fMyTestProjecteXAMPLECompanyCodes(String obj) throws Exception {

		try {
			
			if (obj.equalsIgnoreCase("MyTestProjecteXAMPLE Company Codes")) {
				clickonElement_Xpath(MyTestProjecteXAMPLECompanyCodes);
			}
			...
			clickonElement_Xpath(newButton);
			enterValue_LocatorXpath(input_MyTestProjecteXAMPLECompanyName, "Test1");
			enterValue_LocatorXpath(MyTestProjecteXAMPLECompanyCodeStreetTextBox, sGLShiptoAddress_Line1);
			enterValue_LocatorXpath(MyTestProjecteXAMPLECompanyCodeCityTextBox, sGLShiptoAddress_City);
			enterValue_LocatorXpath(MyTestProjecteXAMPLECompanyCodeStateTextBox, sGLShiptoAddress_State);
			enterValue_LocatorXpath(MyTestProjecteXAMPLECompanyCodeCountryTextBox, sGLShipToCountryCode);
			enterValue_LocatorXpath(MyTestProjecteXAMPLECompanyCodeZipTextBox, sGLShiptoAddress_Zip);
			clickonElement_Xpath(clickOnSaveButton);
	...
	public void fTriggerValidateCompanyAddress(String sOption) throws Exception {

		if (sOption.equalsIgnoreCase("MyTestProjecteXAMPLE Company Codes")) {
			// Trigger validate Ship To address
			clickonElement_Xpath(clickOnValidateCompanyAddress);
		}
	}
	
	
	// Verify Validated Company Address for MyTestProjecteXAMPLE Company Codes
	
	public String fVerifyValidatedCompanyAddress(String sOption) throws Exception {
		String sOnScreenLine1;
		String sOnScreenCity;
		String sOnScreenState;
		String sOnScreenZip;
		...
		if ((sOption.equalsIgnoreCase("MyTestProjecteXAMPLE Company Codes"))) {
			System.out.println("fVerifyValidatedCompanyAddress for : " + sOption);
			ExecutionDelay(20);
			if (IsElementPresent(By.xpath("//b[text()='Line 1:  ']"))) {
				ExecutionDelay(10);
				sOnScreenLine1 = getText("//td[2]/table/tbody/tr/td/div/div/div[2]/div/table/tbody/tr[2]/td");
				...
				sGLActualValidatedAddress = sOnScreenLine1 + ", " + sOnScreenCity + ", " + sOnScreenState + ", "
						+ sOnScreenZip + ", " + sOnScreenCountry;
				System.out.println("Validated Company Address: " + sGLActualValidatedAddress);
				if (sReplaceWithValidAddressFlag.equalsIgnoreCase("1")) {
					System.out.println("if loop");
					clickonElement_Xpath("//a[text()='Update Validated Address']");
					ExecutionDelay(4);
					sGLActualMessageForAddressUpdate = getText("//b[normalize-space()='Company Address is updated successfully']");
					clickonElement_Xpath("//td[contains(@id, 'bottom')]//input[@value='Back']");
				} else {
	...
	public String fLineLevelShipToAddress_Opportunity(String obj) throws Exception {
		String sOnScreenLine1;
		String sOnScreenCity;
		String sOnScreenState;
		String sOnScreenZip;
		...
		try {
			...
			if (obj.equalsIgnoreCase("Line Level Ship To Address: Opportunity")) {
				clickonElement_Xpath(navigateToOpportunityProduct);
				Thread.sleep(3000);
				clickonElement_Xpath(opprtunity_product);
				
				//findAndClick("name", "GenWatt Diesel 1000kW");
			}
			
		//	clickonElement_Xpath("//body[1]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/div[5]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[2]/th[1]");			
			clickonElement_Xpath(editOpportunityProduct);
			Thread.sleep(3000);
			enterValue_LocatorXpath(Opp_ProductStreetTextBox, sGLSecondaryShiptoAddress_Line1);
			enterValue_LocatorXpath(Opp_ProductCityTextBox, sGLSecondaryShiptoAddress_City);
			enterValue_LocatorXpath(Opp_ProductStateTextBox, sGLSecondaryShiptoAddress_State);
			enterValue_LocatorXpath(Opp_ProductZipTextBox, sGLSecondaryShiptoAddress_Zip);
			enterValue_LocatorXpath(Opp_ProductCountryTextBox, sGLSecondaryShipToAddressCountryCode);
			clickonElement_Xpath(SaveOpp_productDetails);
			
			Thread.sleep(3000);
			/*String word = "701 W Ball Rd";
			List<WebElement> list = driver.findElements(By.xpath("//*[@class='detailList']/tbody/tr"));
			...
			// Copy Address for Opportunity Line Level Shipping Address
			...
			sGLOpportunityLineLevelShippingAddress = sOnScreenLine1 + ", " + sOnScreenCity + ", " + sOnScreenState + ", "
					+ sOnScreenZip + ", " + sOnScreenCountry;
			System.out.println("Validated Address for Opportunity Line Level: " + sGLOpportunityLineLevelShippingAddress);
			
		/*	sGLActualValidatedAddress = sGLSecondaryShiptoAddress_Line1 + ", " + sGLSecondaryShiptoAddress_City + ", " + sGLSecondaryShiptoAddress_State + ", "
					+ sGLSecondaryShiptoAddress_Zip + ", " + sGLSecondaryShipToAddressCountryCode;
			System.out.println("Validated Address: " + sGLActualValidatedAddress);*/
			
			Thread.sleep(2000);
			clickonElement_Xpath("//tbody/tr[1]/td[2]/div[1]/a[1]");
			
			
		} catch (Exception oException) {
			System.out.println(oException.getMessage());
		}
		return sGLOpportunityLineLevelShippingAddress;
		
	}
	
	
	public String fOriginAddress_Opportunity(String obj) throws Exception {
		String sOnScreenLine1;
		String sOnScreenCity;
		String sOnScreenState;
		String sOnScreenZip;
		...
		try {
			...
			if (obj.equalsIgnoreCase("Origin Address: Opportunity")) {
		
			clickonElement_Xpath("//td[@id='topButtonRow']//input[@title='Edit']");
			}
			Thread.sleep(3000);
			enterValue_LocatorXpath("//tbody/tr[7]/td[2]/input[1]", sGLSecondaryShiptoAddress_Line1);
			enterValue_LocatorXpath("//tbody/tr[8]/td[2]/input[1]", sGLSecondaryShiptoAddress_City);
			enterValue_LocatorXpath("//tbody/tr[9]/td[2]/input[1]", sGLSecondaryShiptoAddress_State);
			enterValue_LocatorXpath("//tbody/tr[10]/td[2]/input[1]", sGLSecondaryShiptoAddress_Zip);
			enterValue_LocatorXpath("//tbody/tr[11]/td[2]/input[1]", sGLSecondaryShipToAddressCountryCode);
			...
			sGLOpportunityOriginAddress = sOnScreenLine1 + ", " + sOnScreenCity + ", " + sOnScreenState + ", "
					+ sOnScreenZip + ", " + sOnScreenCountry;
			System.out.println("Validated Address for Opportunity Origin Address: " + sGLOpportunityOriginAddress);
			
			
		} catch (Exception oException) {
			System.out.println(oException.getMessage());
		}
		return sGLOpportunityOriginAddress;
			
	}
	
	// ******************************************************************************************************************/
		public String fVerifyTaxValues_ShippingAndHandling(String sMenuOption) throws InterruptedException {

			ExecutionDelay(2);
			clickonElement_Xpath("//td[@id='topButtonRow']//input[@title='Edit']");
			enterValue_LocatorXpath("//input[@id='ShippingHandling']", shippingAndHandling_amount);
			clickonElement_Xpath("//td[@id='topButtonRow']//input[@title='Save']");
			
			ExecutionDelay(2);
			clickonElement_Xpath("//td[@id='topButtonRow']//input[@title='Calculate Tax']");
			ExecutionDelay(2);
			
			if (sMenuOption.equalsIgnoreCase("Quotes")) {
				Thread.sleep(4000);
				expectvisibilityOfElementLocated(shippingAndHanlingTax);
				sGLActualShippingHandlingTax = getText(shippingAndHanlingTax);
				Thread.sleep(1000);
			} 
				return sGLActualShippingHandlingTax;
		}
...
// ******************************************************************************************************************/		
	public String fSaveToMyTestProjecteXAMPLE(String sMenuOption) throws InterruptedException {
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs")) {
			isEnabled("//td[@class='pbButton']//input[@title='Save to MyTestProjecteXAMPLE']");
			clickonElement_Xpath("//td[@class='pbButton']//input[@title='Save to MyTestProjecteXAMPLE']");
			ExecutionDelay(5);
			sGLActualSuccessMessage= getText("//h2[contains(text(),'Success - Your record has been updated successfull')]");
			clickonElement_Xpath("//button[normalize-space()='Back']");
		}
		
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_Disabled")) {
			isEnabled("//td[@class='pbButton']//input[@title='Save to MyTestProjecteXAMPLE']");
			clickonElement_Xpath("//td[@class='pbButton']//input[@title='Save to MyTestProjecteXAMPLE']");
			ExecutionDelay(5);
			sGLActualSuccessMessage= getText("//div[@role='status']//div//h2");
			clickonElement_Xpath("//button[normalize-space()='Back']");
		}

		return sGLActualSuccessMessage;
	}
	
	public String fTaxExemptionCertificate(String sMenuOption) throws InterruptedException {
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_ExpiredDateBeforeIssueDate")) {

			clickonElement_Xpath("//a[normalize-space()='TaxExemption']");
			clickonElement_Xpath("//td[@id='topButtonRow']//input[@title='Edit']");
			ExecutionDelay(3);
			enterValue_LocatorXpath("//input[@id='Name']", "TaxExemption");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgi']", "3/10/2021");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgk']", "3/5/2021");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgj']", "EXPOSURE: NON-DELIVERABLE");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgl']", "Alabama");
			...
			sGLActualSuccessMessage= getText("//h2[contains(text(),'Error - Date issued must be on or before the provi')]");
			clickonElement_Xpath("//button[normalize-space()='Back']");
		}
		
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_PastExpiredDate")) {
			...
			enterValue_LocatorXpath("//input[@id='Name']", "TaxExemption");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgi']", "3/10/2021");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgk']", "3/15/2021");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgj']", "EXPOSURE: NON-DELIVERABLE");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgl']", "Alabama");
			clickonElement_Xpath("//td[@class='pbButtonb']//input[@title='Save']");
			ExecutionDelay(2);
			...
			sGLActualSuccessMessage = getText("//h2[contains(@class,'slds-text-heading_small')]");
			clickonElement_Xpath("//button[normalize-space()='Back']");
			
		}
		
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_FutureExpiredDate")) {
			...
			enterValue_LocatorXpath("//input[@id='Name']", "TaxExemption");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgi']", "3/10/2021");
			enterValue_LocatorXpath("//input[@name='00N4x00000QOcgk']", "3/10/2099");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgj']", "EXPOSURE: NON-DELIVERABLE");
			enterValue_LocatorXpath("//input[@name='CF00N4x00000QOcgl']", "Alabama");
			clickonElement_Xpath("//td[@class='pbButtonb']//input[@title='Save']");
			ExecutionDelay(2);
		...
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_NewTaxExemptionCertificate")) {
	...
	public String fUploadFiles(String sMenuOption) throws InterruptedException, AWTException {
		
		String FilePath = "C:\\AUTOMATION\\Workspaces\\SalesCloud_Automation\\Holiday list 2021.pdf";
		
		if (sMenuOption.equalsIgnoreCase("TaxExemptionCertificate_DisabledMyTestProjecteXAMPLEExemption")) {
			
			
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("document.getElementById('RFLNewFile').style.display = 'block';");
			driver.findElement(By.id("RFLNewFile")).sendKeys(FilePath);
			js.executeScript("document.getElementById('RFLNewFile').style.display = 'none';");
		
			
			/*String filename = "C:\\AUTOMATION\\Workspaces\\SalesCloud_Automation\\Holiday list 2021.pdf";
		    File file = new File(filename);
		    String path = file.getAbsolutePath();
		    // give the URL to upload
		    driver.findElement(By.xpath("//input[@title='Upload Files']")).sendKeys(path);*/
		    
			/*WebElement uploadFiles = driver.findElement(By.xpath("//input[@title='Upload Files']"));
			uploadFiles.sendKeys("C:\\Users\\kumar.anurag\\Downloads\\Gym Bill_Feb.pdf");*/
			//"C:\\AUTOMATION\\Workspaces\\SalesCloud_Automation\\Holiday list 2021.pdf"
			ExecutionDelay(5);
			Thread.sleep(5000);
			clickonElement_Xpath("//input[@id='multiUploadCloseBtn']");
			ExecutionDelay(2);
			System.out.println("File is Uploaded Successfully");
			clickonElement_Xpath("//td[@class='pbButton']//input[@title='Upload Certificate']");
			sGLActualSuccessMessage= getText("//h2[contains(@class,'slds-text-heading_small')]");
			clickonElement_Xpath("//button[normalize-space()='Back']");
		   
		}
		
		if (sMenuOption.equalsIgnoreCase("TaxExemptionCertificate_EnabledMyTestProjecteXAMPLEExemption")) {
			...
			System.out.println("File is Uploaded Successfully");
			clickonElement_Xpath("//td[@class='pbButton']//input[@title='Upload Certificate']");
			clickonElement_Xpath("//input[@name='fileSelection']");
			ExecutionDelay(2);
			clickonElement_Xpath("//button[normalize-space()='Upload']");
			ExecutionDelay(2);
			sGLActualSuccessMessage = getText("//h2[normalize-space()='Certificate saved to MyTestProjecteXAMPLE']");
			clickonElement_Xpath("//button[normalize-space()='Back']");

		}
		
		if (sMenuOption.equalsIgnoreCase("TaxExemptionCertificate_UploadFiles")) {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("document.getElementById('RFLNewFile').style.display = 'block';");
			driver.findElement(By.id("RFLNewFile")).sendKeys(FilePath);
			js.executeScript("document.getElementById('RFLNewFile').style.display = 'none';");
	...
	public String fInvalidateCertificate(String sMenuOption) throws InterruptedException {
		if (sMenuOption.equalsIgnoreCase("TaxExemption_ACcs_InvalidateCertificate")) {
			clickonElement_Xpath("//td[@class='pbButton']//input[@title='Invalidate Certificate']");
			sGLActualSuccessMessage= getText("//h2[contains(@class,'slds-text-heading_small')]");
			clickonElement_Xpath("//button[normalize-space()='Back']");
		}

...
public class objectRepositoryClass {
	...
	//////// CHROME /////////
	protected static String sGLBrowser = System.setProperty("webdriver.chrome.driver", "chromedriver.exe");
	...
	// Date Format
	protected static String sGLDate = "5/2/2019";
	protected static String OverrideTaxDate = "5/5/2019";

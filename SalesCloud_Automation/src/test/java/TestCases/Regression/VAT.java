...
public class VAT extends functionLibrary {
	...
	@Test(priority = 3, enabled = true, description = "Ship to:US and Ship from: Great Brighton")
	public void TestCase117_Shipto_US_Shipfrom_GreatBrighton() throws Exception {
		calculateVATTax_BlankInvoiceMessaging("TestCase117");
	}

	@Test(priority = 4, enabled = true, description = "Ship to:Great Brighton and Ship from:US")
	public void TestCase118_Shipto_GreatBrighton_Shipfrom_US() throws Exception {
		calculateVATTax_BlankInvoiceMessaging("TestCase118");
	}

	@Test(priority = 5, enabled = true, description = "Ship to:US and Ship from: US")
	public void TestCase119_Shipto_US_Shipfrom_US() throws Exception {
		calculateVATTax_BlankInvoiceMessaging("TestCase119");
	}

	@Test(priority = 6, enabled = true, description = "Ship to:AUS and Ship from: Great Brighton")
	public void TestCase120_Shipto_AUS_Shipfrom_GreatBrighton() throws Exception {
		calculateVATTax_AustraliaAddress("TestCase120");
	}

	@Test(priority = 7, enabled = true, description = "Ship to:Great Brighton and Ship from: AUS")
	public void TestCase121_Shipto_GreatBrighton_Shipfrom_AUS() throws Exception {
